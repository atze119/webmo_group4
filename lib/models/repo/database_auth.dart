...
class DatabaseAuth{
  ...
  final CollectionReference adminCollection = FirebaseFirestore.instance.collection("AdminCollection");
  ...
  Future<bool> isAdmin() async {
    try {
      final adminCollection = FirebaseFirestore.instance.collection("AdminCollection");
